...
export class GitService
{
    ...
    async cherrypickCommit(commitHash: string): Promise<{ success: boolean, message: string }>
    {
    ...
    async cherrypickRange(fromCommit: string, toCommit: string): Promise<{ success: boolean, message: string }>
    {
